...
SECRET_KEY = 'django-insecure-2%pljfqlm1308n39vjzc5(7s@wj((hyqk14993t36)(@%okeck'
...
# UPI payment settings (used to generate UPI QR codes)
# Set your merchant VPA and display name here
UPI_VPA = 'merchant@upi'
UPI_NAME = 'EcommerceStore'
